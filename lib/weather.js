...
export const getClothingSuggestion = (temp) => {
  ...
  if (temp > 85) return "Wear light clothes and a hat - it's hot!";
  if (temp > 75) return "Perfect for short sleeves and light clothes.";
  if (temp > 65) return "A light sweater or jacket might be nice.";
  if (temp > 50) return "Dress warmly with a jacket.";
  return "Bundle up with a coat, hat, and gloves!";
};

/**
 * Gets weather description for the day based on condition and temperature
 */
